...
function Base(props) {
  var style = props.style,
      ...
      error = props.error,
      restOfProps = __rest(props, ["style", "className", "children", "success", "raised", "backgroundColor", "disabled", "error"]);
  ...
  return React.createElement(Fragment, null, React.createElement("button", _extends({
    ...
    style: __assign({
      ...
      boxShadow: raised ? "0 2px 3px hsla(0, 0%, 0%, 0.2), inset 0px 2px 0px " + insetColor : undefined
    }, style),
    disabled: disabled
  }, restOfProps), React.createElement("div", {
    className: "button-text relative"
...
var Blank = function (_a) {
  ...
  return React.createElement("button", _extends({
    style: style // className={`${styles.ButtonBlank} ${className}`}
    ,
    ref: nativeElRef
...
var css$1 = ".CohubDropdownButton li:focus, .CohubDropdownButton li:hover {\n  background-color: #f2f2f2; }\n";
styleInject(css$1);
...
function (_super) {
  ...
  Dropdown.prototype.render = function () {
    ...
    var _a = this.props,
        ...
        backgroundColor = _c === void 0 ? Color$1.primary : _c;
    var _d = this.state,
        _e = _d.selectedOption,
        onClick = _e.onClick,
        label = _e.label,
    ...
    return React.createElement("div", {
      ...
      style: {
        boxShadow: '0 4px 20px rgba(0,0,0,0.19), 0px 0px 6px rgba(0,0,0,0.23)',
        backgroundColor: Color$1.trueWhite
      },
...
function (_super) {
  ...
  Buttons.prototype.render = function () {
    return React.createElement(Buttons.Base, this.props);
  };
...
export { Base, BoxShadow$1 as BoxShadow, Buttons, Color$1 as Color, CssVariables as CssFramework, Icon, Split as SplitButton, StoryHelpers, Typography };
